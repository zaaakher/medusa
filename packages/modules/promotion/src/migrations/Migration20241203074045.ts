...
export class Migration20241203074045 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('CREATE INDEX IF NOT EXISTS "IDX_promotion_campaign_budget_type" ON "promotion_campaign_budget" (type) WHERE deleted_at IS NULL;');
    ...
    this.addSql('CREATE INDEX IF NOT EXISTS "IDX_promotion_application_method_type" ON "promotion_application_method" (type) WHERE deleted_at IS NULL;');
    this.addSql('CREATE INDEX IF NOT EXISTS "IDX_promotion_application_method_target_type" ON "promotion_application_method" (target_type) WHERE deleted_at IS NULL;');
    this.addSql('CREATE INDEX IF NOT EXISTS "IDX_promotion_application_method_allocation" ON "promotion_application_method" (allocation) WHERE deleted_at IS NULL;');
  ...
  async down(): Promise<void> {
    ...
    this.addSql('drop index if exists "IDX_promotion_application_method_target_type";');
    this.addSql('drop index if exists "IDX_promotion_application_method_allocation";');
