 ...
 *         - type: string
 *           title: region_id
 *           description: Filter by a region ID to retrieve its associated draft orders.
 *         - type: array
 *           description: Filter by region IDs to retrieve their associated draft orders.
 *           items:
 *             type: string
 ...
 *         - type: string
 *           title: customer_id
 *           description: Filter by a customer ID to retrieve their draft orders.
 *         - type: array
 *           description: Filter by customer IDs to retrieve their draft orders.
 *           items:
 *             type: string
 *             title: customer_id
