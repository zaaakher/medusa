...
export const highlights = [
  ...
  ["5", "logger", "Resolve the logger from the container"],
  ["10", "config", "The scheduled job's configurations."],
  ["11", "name", "The job's unique name"],
  ["12", "schedule", "The schedule to run the job on."]
]
