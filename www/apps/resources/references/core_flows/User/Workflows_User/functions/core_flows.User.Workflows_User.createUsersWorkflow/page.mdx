...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/1758bfb8d042fa9fc82f23c36ccd61e4a439448e/packages/core/core-flows/src/user/workflows/create-users.ts#L16" />
  ...
  () => {
    const result = createUsersWorkflow
      .runAsStep({
        input: {
          "users": [{
            "email": "Marina_Hudson@hotmail.com"
          }]
        }
      })
  }
