...
<WorkflowDiagram workflow={{"name":"createUserAccountWorkflow","steps":[{"type":"workflow","name":"createUsersWorkflow","description":"This workflow creates one or more users.","link":"../../../../Workflows_User/functions/core_flows.Workflows_User.createUsersWorkflow/page.mdx","depth":1},{"type":"step","name":"setAuthAppMetadataStep","description":"This step sets the `app_metadata` property of an auth identity.","link":"../../../../Steps_Auth/functions/core_flows.Steps_Auth.setAuthAppMetadataStep/page.mdx","depth":2}]}} />
