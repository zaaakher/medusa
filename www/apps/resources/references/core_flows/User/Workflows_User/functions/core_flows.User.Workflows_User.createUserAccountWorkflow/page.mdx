...
<WorkflowDiagram workflow={{"name":"createUserAccountWorkflow","steps":[{"type":"workflow","name":"createUsersWorkflow","description":"This workflow creates one or more users.","link":"../core_flows.User.Workflows_User.createUsersWorkflow/page.mdx","depth":1},{"type":"step","name":"setAuthAppMetadataStep","description":"This step sets the `app_metadata` property of an auth identity.","link":"../../../../Auth/Steps_Auth/functions/core_flows.Auth.Steps_Auth.setAuthAppMetadataStep/page.mdx","depth":2}]}} />
