...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/1758bfb8d042fa9fc82f23c36ccd61e4a439448e/packages/core/core-flows/src/user/workflows/create-user-account.ts#L20" />
    ...
    const result = createUserAccountWorkflow
      .runAsStep({
        input: {
          ...
          "userData": {
            "email": "Hans.Hagenes78@gmail.com"
          }
        }
      })
  }
