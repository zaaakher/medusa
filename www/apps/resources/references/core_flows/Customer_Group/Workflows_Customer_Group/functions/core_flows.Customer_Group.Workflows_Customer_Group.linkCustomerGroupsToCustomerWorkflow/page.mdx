...
<WorkflowDiagram workflow={{"name":"linkCustomerGroupsToCustomerWorkflow","steps":[{"type":"step","name":"linkCustomerGroupsToCustomerStep","description":"This step creates one or more links between a customer and customer groups records.","link":"../../../../Steps_Customer_Group/functions/core_flows.Steps_Customer_Group.linkCustomerGroupsToCustomerStep/page.mdx","depth":1}]}} />
