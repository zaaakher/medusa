...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/1758bfb8d042fa9fc82f23c36ccd61e4a439448e/packages/core/core-flows/src/invite/workflows/create-invites.ts#L15" />
  ...
  () => {
    const result = createInvitesWorkflow
      .runAsStep({
        input: {
          "invites": [{
            "email": "Duane_Wehner@hotmail.com"
          }]
        }
      })
  }
