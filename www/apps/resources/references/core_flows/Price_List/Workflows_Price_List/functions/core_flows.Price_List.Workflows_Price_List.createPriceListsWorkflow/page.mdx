...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/1758bfb8d042fa9fc82f23c36ccd61e4a439448e/packages/core/core-flows/src/price-list/workflows/create-price-lists.ts#L20" />
    ...
    const result = createPriceListsWorkflow
      .runAsStep({
        input: {
          "price_lists_data": [{
            "title": "capto",
            "description": "Cauda minus abduco deputo."
          }]
        }
      })
  }
