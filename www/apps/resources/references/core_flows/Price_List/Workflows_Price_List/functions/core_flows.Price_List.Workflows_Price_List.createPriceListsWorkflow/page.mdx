...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/1b86c17b7293f3b810c062d78ec6ef563f968366/packages/core/core-flows/src/price-list/workflows/create-price-lists.ts#L20" />
    ...
    const result = createPriceListsWorkflow
      .runAsStep({
        input: {
          "price_lists_data": [{
            "title": "iste",
            "description": "Auxilium aurum aetas territo spero caelum."
          }]
        }
      })
  }
...
<WorkflowDiagram workflow={{"name":"createPriceListsWorkflow","steps":[{"type":"step","name":"validateVariantPriceLinksStep","description":"This step validates that the specified variants have prices.\n\n","link":"../../../Steps_Price_List/functions/core_flows.Price_List.Steps_Price_List.validateVariantPriceLinksStep/page.mdx","depth":1},{"type":"step","name":"createPriceListsStep","description":"This step creates a price list.\n\n","link":"../../../Steps_Price_List/functions/core_flows.Price_List.Steps_Price_List.createPriceListsStep/page.mdx","depth":2}]}} />
