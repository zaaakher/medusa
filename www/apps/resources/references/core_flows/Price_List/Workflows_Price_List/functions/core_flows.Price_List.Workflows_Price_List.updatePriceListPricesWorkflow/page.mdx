...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/1b86c17b7293f3b810c062d78ec6ef563f968366/packages/core/core-flows/src/price-list/workflows/update-price-list-prices.ts#L19" />
...
export async function POST(
  ...
  const { result } = await updatePriceListPricesWorkflow(req.scope)
    .run({
      input: {
        "data": [{
          "id": "id_KVXH6hWo4wmgEj8m4z",
          "prices": [{
            "id": "id_wr7PZQ4daJ8KpVb8dHW",
            "variant_id": "{value}"
          }]
        }]
      }
