...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/1b86c17b7293f3b810c062d78ec6ef563f968366/packages/core/core-flows/src/inventory/workflows/bulk-create-delete-levels.ts#L25" />
...
<WorkflowDiagram workflow={{"name":"bulkCreateDeleteLevelsWorkflow","steps":[{"type":"when","condition":"{\n      return !!input.deletes?.length\n    }","depth":"1","steps":[{"type":"workflow","name":"deleteInventoryLevelsWorkflow","description":"This workflow deletes one or more inventory levels.\n\n","link":"../core_flows.Inventory.Workflows_Inventory.deleteInventoryLevelsWorkflow/page.mdx","depth":1}]},{"type":"when","condition":"{\n      return !!input.creates?.length\n    }","depth":"2","steps":[{"type":"step","name":"createInventoryLevelsStep","description":"This step creates one or more inventory levels.\n\n","link":"../../../Steps_Inventory/functions/core_flows.Inventory.Steps_Inventory.createInventoryLevelsStep/page.mdx","depth":2}]}]}} />
