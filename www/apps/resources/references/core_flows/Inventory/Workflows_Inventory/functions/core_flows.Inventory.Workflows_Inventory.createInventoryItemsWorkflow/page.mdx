...
<SourceCodeLink link="https://github.com/medusajs/medusa/blob/2f7ec55f2e37df2696c8c1d639f727fcdfd8d9e6/packages/core/core-flows/src/inventory/workflows/create-inventory-items.ts#L110" />
...
<WorkflowDiagram workflow={{"name":"createInventoryItemsWorkflow","steps":[{"type":"step","name":"createInventoryItemsStep","description":"This step creates one or more inventory items.","link":"../../../Steps_Inventory/functions/core_flows.Inventory.Steps_Inventory.createInventoryItemsStep/page.mdx","depth":1},{"type":"workflow","name":"createInventoryLevelsWorkflow","description":"This workflow creates one or more inventory levels. It's used by the\n[Create Inventory Level API Route](https://docs.medusajs.com/api/admin#inventory-items\\_postinventoryitemsidlocationlevels).\n\nYou can use this workflow within your own customizations or custom workflows, allowing you\nto create inventory levels in your custom flows.","link":"../core_flows.Inventory.Workflows_Inventory.createInventoryLevelsWorkflow/page.mdx","depth":2}]}} />
