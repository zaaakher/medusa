...
const myWorkflow = createWorkflow(
  ...
  () => {
    const data = orderFulfillmentDeliverablilityValidationStep({
      "order": {
        "id": "id_5a88otS0svBT9KjZN1H",
        "version": 9,
        "display_id": 30,
        "status": "requires_action",
        "currency_code": "{value}",
        "created_at": "2026-01-04T13:03:07.427Z",
        "updated_at": "2025-09-05T19:49:50.632Z",
        "original_item_total": {
          "numeric": 36
        },
        ...
        "provider": {
          ...
          "shipping_options": [{
            ...
            "type": {
              "id": "id_p4iBeFN3Hc",
              "label": "{value}",
              "description": "Conculco patria convoco.",
              "code": "{value}",
              "shipping_option_id": "{value}",
              "shipping_option": {
                "id": "id_Qrrr3FwcheIW5MjZ2kxr",
                "name": "Nolan",
                "price_type": {},
                "service_zone_id": "{value}",
                "shipping_profile_id": "{value}",
