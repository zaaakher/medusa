  ...
  () => {
    const data = orderFulfillmentDeliverablilityValidationStep({
      "order": {
        ...
        "status": "pending",
        "currency_code": "{value}",
        "created_at": "2025-07-25T09:48:14.196Z",
        "updated_at": "2025-01-21T08:15:30.754Z",
        "original_item_total": {
          "numeric": 8
        },
      ...
      "fulfillment": {
        ...
        "requires_shipping": true,
        "provider": {
          "id": "id_M6kyCHUOV0qQ8kcigw",
          "name": "Alexander",
          "metadata": {},
          "shipping_options": [{
            "id": "id_esAR8am17QDLw32QpXF",
            "name": "Mona",
            ...
            "type": {
              "id": "id_FFwd6JkfRDWdl",
              "label": "{value}",
              "description": "Comitatus casso tabesco absconditus vorax.",
              "code": "{value}",
        ...
        "labels": [{
          "id": "id_kg0Q1mgiAdJLgK2su",
          "tracking_number": "{value}",
          "tracking_url": "{value}",
          "label_url": "{value}",
          "fulfillment_id": "{value}",
          "fulfillment": {
            "id": "id_UOgXrELoXmc8A2",
            "location_id": "{value}",
            "packed_at": {},
            "shipped_at": {},
            "delivered_at": {},
